...
# ## Using CSV## The package [CSV.jl](https://github.com/JuliaData/CSV.jl) offers a powerful way to read arbitrary CSV files efficiently.# In particular the `CSV.read` function allows to read a file and return a DataFrame.## ### Basic usage## Let's say you have a file `scripts/data/foo.csv` with the content## ```plaintext# col1,col2,col3,col4,col5,col6,col7,col8# ,1,1.0,1,one,2019-01-01,2019-01-01T00:00:00,true# ,2,2.0,2,two,2019-01-02,2019-01-02T00:00:00,false# ,3,3.0,3.14,three,2019-01-03,2019-01-03T00:00:00,true# ```## You can read it with CSV using
using CSV
