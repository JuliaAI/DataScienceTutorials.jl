...
# ### Example 2## Let's consider [this dataset](https://archive.ics.uci.edu/ml/machine-learning-databases/00423/), the content of which we saved in `data/hcc.txt`.# It does not have a header and missing values indicated by `?`.
