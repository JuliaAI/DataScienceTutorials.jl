...
# ![Distribution of salary](/assets/literate/ISL-lab-6-g2.svg)## ### Data preparation## Most features are currently encoded as integers but we will consider them as continuous
...
# ### Basic Ridge## Let's now swap the linear regressor for a Ridge one without specifying the penalty (`1` by default):
...
# ![Ridge residuals](/assets/literate/ISL-lab-6-g5.svg)## You can compare that with the residuals obtained earlier.
